...
public class Onibus implements MeioDeTransporte{
    ...
    // construct
    public Onibus(double valorAcelerador, double valorFreio, double velocidade){ this.valorAcelerador = valorAcelerador; this.valorFreio = valorFreio; this.velocidade = velocidade; }
